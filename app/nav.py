...
FOOTER = [
    ("/jobs", "jobs", "Jobs", ("/jobs",)),
    ("/settings", "settings", "Settings", ("/settings", "/accounts", "/pixels", "/creators", "/partners", "/locations", "/cookies", "/oauth", "/escape-test", "/campaigns/source-check", "/bc-assets")),
]
...
JUMP = [
    ...
    ("/monitor", "Health", "Monitor", "issues rejected ads blocked accounts"),
    ("/monitor?view=balances", "Balances", "Monitor", "business center wallet top up"),
    ("/monitor?view=automation", "Automation", "Monitor", "rules auto pause paused campaigns resume"),
    ("/monitor?view=system", "System status", "Monitor", "cookies token sync"),
