...
SLOW_KINDS = {"instant_page_clone_all", "issues_scan", "appeals_refresh", "pixels_sync", "pixel_link_all", "audience_sync", "music_sync", "identities_sync", "spark_authorize", "bc_assets_scan", "bc_assets_wire", "bc_assets_connect", "adgroup_duplicate"}
LAUNCH_KINDS = {"launch"}
