  ...
  window.LR = {
    mount: function (el, o) {
      ...
      function draw() {
        ...
        var th = "<tr><th>Account</th>" + cols.map(function (c) { return "<th>" + c[1] + "</th>"; }).join("") + '<th title="The start time as Ads Manager will show it, in the ad account\'s own timezone — always an hour before its clock, so the ad group starts at once">Starts</th></tr>';
