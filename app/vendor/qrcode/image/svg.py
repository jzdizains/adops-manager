...
from app.vendor.qrcode.image import base as _qrbase
from app.vendor.qrcode.compat.etree import ET
from app.vendor.qrcode.image.styles.moduledrawers import svg as svg_drawers
from app.vendor.qrcode.image.styles.moduledrawers.base import QRModuleDrawer


class SvgFragmentImage(_qrbase.BaseImageWithDrawer):
    """
    SVG image builder
...
class SvgImage(SvgFragmentImage):
    ...
    drawer_aliases: _qrbase.DrawerAliases = {
