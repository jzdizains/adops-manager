...
from app.vendor.qrcode.compat.pil import Image, ImageDraw
from app.vendor.qrcode.image.styles.moduledrawers.base import QRModuleDrawer

if TYPE_CHECKING:
    from app.vendor.qrcode.image.styledpil import StyledPilImage
    from app.vendor.qrcode.main import ActiveWithNeighbors
