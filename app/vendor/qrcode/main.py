...
from app.vendor.qrcode import constants, exceptions, util
from app.vendor.qrcode.image.base import BaseImage
PyPNGImage = None  # vendored copy: SVG only
    ...
    def make_image(self, image_factory=None, **kwargs):
        ...
        if image_factory is not None:
            ...
            if image_factory is None:
                from app.vendor.qrcode.image.pil import Image, PilImage
