from app.vendor.qrcode.main import QRCode
from app.vendor.qrcode.main import make  # noqa
from app.vendor.qrcode.constants import (  # noqa
    ERROR_CORRECT_L,
    ERROR_CORRECT_M,
    ERROR_CORRECT_Q,
    ERROR_CORRECT_H,
...
from app.vendor.qrcode import image  # noqa
