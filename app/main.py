...
from .routes import (
    ad_texts, alerts, appeals_page, audience, auth, automation, campaigns, jobs_page, partners_page, cookies_admin, creatives, dashboard,
...
for r in (auth.router, security.router, oauth.router, dashboard.router,
          ...
          appeals_page.router, partners_page.router, jobs_page.router, audience.router):
