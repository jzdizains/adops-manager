...
check("CSS for the rows + STATIC_VERSION bumped", ".sp-row-in" in css and ".sp-in-code" in css and 'STATIC_VERSION = "164"' in open(os.path.join(ROOT, "app", "config.py"), encoding="utf-8").read())
