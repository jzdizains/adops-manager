...
check("the cross-workspace error feed is owner-only (page, json, seen)", dg.count("guard.is_owner(request)") == 5)   # + the test-mode switch (v153), + who connected TikTok (v155.12)
