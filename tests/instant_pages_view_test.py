...
check("CSS for the new pieces + STATIC_VERSION bumped", ".ip-star.on" in css and ".cov-bar" in css and ".ipd-row" in css and 'STATIC_VERSION = "185"' in read("app/config.py"))
