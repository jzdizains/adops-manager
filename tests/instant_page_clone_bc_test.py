...
check("Clone to… now opens the reusable account pop-up and posts the multi-select to clone-multi", "UI.pickAccounts({" in js and 'postForm("/instant-pages/clone-multi"' in js and "target_ids: r.ids.join" in js and 'class="ip-bc-form"' not in t)
